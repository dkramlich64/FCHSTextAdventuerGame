...
class movement(player):
  def __init__(self):
    self.x = 0
    self.y = 0
    self.rooms = [(0,0),(0,2),(0,4),(2,0),(2,1),(2,2),(2,4),(4,0),(4,2),(4,4),(8,0),(8,2),(8,4)]
  ...
  def north(self):
    ...
    if (self.y - 1 < 0 or move):
      ...
      self.y -= 1
      print("You moved North, your location is area: " + '('+ str(self.x) + ','+ str(self.y) + ')' + " in the y direction") 
  ...
  def south(self): 
    ...
    if (self.y + 1 > 4 or move):
      ...
      self.y += 1 
      print("You moved South, your location is area: " + '('+ str(self.x) + ','+ str(self.y) + ')' + " in the y direction")
  '''
  west
  no parameters are needed for this function
  ...
  def west(self): 
    ...
    if (self.x - 1 < 0 or move):
      ...
      self.x -= 1
      print("You moved West, your location is area: " + '('+ str(self.x) + ','+ str(self.y) + ')' + " in the x direction")
  ...
  def east(self):
    ...
    if (self.x + 1 > 9 or move):
      ...
      self.x += 1 
      print("You moved East, your location is area: " + '('+ str(self.x) + ','+ str(self.y) + ')' + " in the x direction")
